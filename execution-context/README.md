...
导读：以前总是看到相关文章提到什么变量提升，函数提升啥的，什么函数提升优先级大于变量的，总是知其然，不知其所以然，当面试官拿着同一name，却不断function, 和var赋值，然后让你告诉他每一个阶段该谁什么值的时候，拿着啥变量提升和函数提升是解释不通的，至少我不能-_-。David Shariff的这篇文章为我们讲述了其中的原理，让人看了豁然开朗
